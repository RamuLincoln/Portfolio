  ...
  return (
    <section id='intro'>
        <motion.div style={{ x:25 }} animate={{ x: 10, y:-10 }} className='introContent'>
            ...
            <p className='introPara'>Full Stack Developer with experience building web applications, IoT data platforms, and real-time monitoring dashboards. 
              Skilled in React, Python, SQL, PostgreSQL, and API development. Experienced in transforming sensor and operational data into actionable insights through modern web technologies. <br />  Vue JavaScript, Python, MySQL</p>
